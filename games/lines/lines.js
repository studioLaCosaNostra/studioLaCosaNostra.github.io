...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string" ) {
            ...
            var wasm_path = path.join( __dirname, "lines.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "lines.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'lines'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'lines':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__cargo_web_snippet_62a9776aede9769de617ba4e85a6ca6a1f388b97": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);window.open(($0));
            },
            ...
            "__cargo_web_snippet_7cd175ce32c6b1af1e392db44118bfdaf6f5d036": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);var config_loaded=($0);fetch("./assets/config.json").then((response)=>response.json()).then(config_loaded);
            },
            ...
            "__cargo_web_snippet_e590393069479c7e36fcd47cdf6a9f05f801d58b": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){console.log("Ads show.");if(! window.admob)return;admob.interstitial.show();})());
            },
            ...
            "__cargo_web_snippet_eddcef8259d5e6bb6e934adb41d9071dc5f3221c": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){console.log("Ad load.");if(! window.admob)return;var android=($1);console.log(android);admob.interstitial.load({id:{android:android},});})());
            },
